  ...
  const clients = [
    {
      ...
      logo: "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&h=200&fit=crop&crop=center",
      industry: "Technology",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400&h=200&fit=crop&crop=center",
      industry: "Retail",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=400&h=200&fit=crop&crop=center",
      industry: "Healthcare",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=400&h=200&fit=crop&crop=center",
      industry: "Banking",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1497486751825-1233686d5d80?w=400&h=200&fit=crop&crop=center",
      industry: "Education",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=400&h=200&fit=crop&crop=center",
      industry: "Energy",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=400&h=200&fit=crop&crop=center",
      industry: "Logistics",
    ...
    },
    {
      ...
      logo: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=200&fit=crop&crop=center",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8 mb-16">
          {clients?.map((client) => (
            <div
              key={client?.id}
              className="group relative bg-white dark:bg-card rounded-2xl border border-border/80 p-5 sm:p-6 hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden flex flex-col justify-between"
            >
              {/* Logo / Feature Image */}
              <div>
                <div className="aspect-[2/1] mb-4 overflow-hidden rounded-xl bg-muted relative">
                  <Image
                    src={client?.logo}
                ...
                <div className="text-center">
                  <h3 className="font-bold text-foreground text-sm sm:text-base mb-1 group-hover:text-primary transition-colors truncate">
                    {client?.name}
                  </h3>
              ...
              {/* Hover Testimonial Overlay - Solid & Completely Opaque */}
              <div className="absolute inset-0 bg-white dark:bg-slate-900 rounded-2xl border-2 border-primary/30 p-5 sm:p-6 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-between text-center shadow-xl z-20 pointer-events-none group-hover:pointer-events-auto">
                ...
                <p className="text-xs sm:text-sm text-foreground/90 font-medium leading-relaxed my-auto italic px-1">
                  "{client?.testimonial}"
                </p>

                <div className="w-full pt-2 border-t border-border/80">
